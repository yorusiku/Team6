...
export default class ProductTiles extends LightningElement {
  ...
  sendGeneralDeviceMessageService(generaldeviceproductId) {
    publish(this.messageContextthree, GENERALPRODUCTM, {
      recordId: generaldeviceproductId
    });
  }
  ...
  async refresh() {
    ...
    await Promise.all([
      ...
      refreshApex(this.notebookProducts),
      refreshApex(this.generalDeviceProducts)
    ]);
